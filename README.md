...
**Ilik** is an open-source platform that lets LLMs create interactive 2D math visualizations. Connect any MCP-compatible model to explain calculus concepts through step-by-step lessons — each with live graphs, symbolic analysis, and explanations written by the model itself.

Built with Python · FastAPI · SymPy · Vue 3 · TypeScript
